...
export function MyIcon({ info, onPress }: { info: IconProps, onPress?: () => void }) {
    ...
    // @ts-ignore
    return <IconElem name={info.name} size={info.size || 22} color={info.color || defaultIconColor} style={{ width: info.size, height: info.size, margin: 0, padding: 0 }} onPress={onPress} />
}
